...
import java.util.*;
public class PreDay extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pre_day);
        //first budget
        final double budget = 50.00;
        //Day 1
        final int day = 1;
        ...
        newDay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Set up intent
                Intent intent = new Intent(PreDay.this, EndDay.class);
                //Send stuff
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Set up intent
                Intent intent = new Intent(PreDay.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
